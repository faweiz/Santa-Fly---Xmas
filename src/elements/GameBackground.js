...
var GameBackground = cc.Layer.extend({
    ...
    ctor:function () {
        ...
        //sky
        this._bg1 = buildParallaxBackground("res/graphics/bg.jpg");
        this.addChild(this._bg1);

        //hill
        this._bg2 = buildParallaxBackground("#layer2.png");  
        this.addChild(this._bg2);

        //buildings
        this._bg3 = buildParallaxBackground("#layer3.png");
        this.addChild(this._bg3);

        //trees
        this._bg4 = buildParallaxBackground("#layer4.png");
